import { ElementType, ingredients, IIngredient } from "../data.ts";
import { addIngredient } from "./addIngredient.ts";

export const printIngredients = (potionsDone: string[]) => {
...
const getElementData = (
  element: ElementType,
): { emoji: string; bgColor: string; color: string } => {
  switch (element) {
    case "fire":
...
export const createIngredientCard = (
